...
/**
 * Check whether this and `other` Instance reference the same row
 *
...
Instance.prototype.equals = function(other) {
  ...
  if (this.get(this.Model.primaryKeyAttribute, {raw: true}) !== other.get(this.Model.primaryKeyAttribute, {raw: true})) {
    return false;
  }
